...
<form action="<?= site_url('admin/riwayat_pendidikan/update/'); ?><?= esc($riwayat_pendidikan['id']); ?>" method="post" enctype="multipart/form-data" id="editriwayatPendidikanForm" class="needs-validation" novalidate>
    <?= csrf_field(); ?>
