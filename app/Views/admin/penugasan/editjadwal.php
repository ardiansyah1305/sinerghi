    ...
    $(document).ready(function() {
        ...
        $('.pegawai-tab').click(function() {
            ...
            if (hasCalendarChanges) {
                ...
                // Auto save tanpa konfirmasi dan tanpa pesan sukses
                saveJadwalSilent(newPegawaiId);
            } else {
        ...
        // Fungsi untuk menyimpan jadwal tanpa menampilkan pesan sukses
        function saveJadwalSilent(newPegawaiId) {
            if (!selectedPegawai) {
                switchToPegawai(newPegawaiId);
                return;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        // Pindah ke pegawai yang dipilih
                        switchToPegawai(newPegawaiId);
                    } else {
                        Swal.fire({
                            icon: 'error',
