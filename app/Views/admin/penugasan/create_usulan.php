                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" id="btnGenerateTemplate" class="btn btn-success">
                                            <i class="bi bi-file-earmark-excel"></i> Generate Template
                                        </button>
                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnGenerateTemplate').on('click', function() {
            ...
            $.ajax({
                url: '<?= base_url('admin/penugasan/generate-excel-template'); ?>',
                type: 'POST',
                data: {
                    bulan: bulan
                },
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        Swal.fire({
                            ...
                            text: 'Template Excel dengan data pegawai berhasil dibuat',
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Gagal',
                            text: response.message || 'Gagal membuat template Excel',
                            showConfirmButton: true
                        });
                    }
                },
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Terjadi kesalahan saat membuat template Excel. Silakan coba lagi.',
                        showConfirmButton: true
                    });
                },
                complete: function() {
            ...
            if (file) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Disable tombol simpan jika terjadi error
                ...
                // Disable tombol simpan jika tidak ada file yang dipilih
                $('#btnSubmit').prop('disabled', true);
            }
        });
        ...
        function clearErrors() {
            ...
            // Disable tombol simpan ketika membersihkan error
            $('#btnSubmit').prop('disabled', true);
        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'error') {
                        ...
                        // Jika sukses, langsung redirect tanpa pop-up
        ...
        function clearErrors() {
            $('.error-message').remove(); // Hapus semua pesan error sebelumnya
            $('.form-control').removeClass('is-invalid'); // Hapus tanda error pada input
        }
            ...
            if (errors) {
                $.each(errors, function(field, message) {
                    ...
                    if (inputField.length) {
                        ...
                        // Jika field tidak ditemukan, tampilkan error global di atas form
                        $('#globalError').html('<div class="alert alert-danger">' + message + '</div>');
                    }
                });
            }
        }
