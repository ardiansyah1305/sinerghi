...
<div class="container-fluid mt-4">
    ...
    <div class="section-wrapper slider-section">
        ...
        <div class="form-wrapper">
            <?= $this->include('pegawai/beranda/create_slider'); ?>
        </div>
                    ...
                    <?php foreach ($sliders as $slider): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('pegawai/beranda/deleteSlider/' . $slider['id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this slider?');">Delete</a>
                            </td>
                        </tr>
                        <!-- Edit Slider Modal -->
                        <div class="modal fade" id="editSliderModal<?= $slider['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editSliderModalLabel<?= $slider['id']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= site_url('pegawai/beranda/updateSlider/' . $slider['id']); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="section-wrapper popup-section">
        <h3>Popup</h3>
        <div class="form-wrapper">
            <?= $this->include('pegawai/beranda/create_popup'); ?>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    ...
                    <?php foreach ($popups as $popup): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('pegawai/beranda/deletePopup/' . $popup['id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this popup?');">Delete</a>
                            </td>
                        </tr>
                        <!-- Edit Popup Modal -->
                        <div class="modal fade" id="editPopupModal<?= $popup['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editPopupModalLabel<?= $popup['id']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= site_url('pegawai/beranda/updatePopup/' . $popup['id']); ?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="image">Image</label>
                                                <input type="file" class="form-control" id="image" name="image">
    ...
    <div class="section-wrapper card-section">
        <h3>Card</h3>
        <div class="form-wrapper">
            <?= $this->include('pegawai/beranda/create_card'); ?>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    ...
                    <?php foreach ($cards as $card): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('pegawai/beranda/deleteCard/' . $card['id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this card?');">Delete</a>
                            </td>
                        </tr>
                        <!-- Edit Card Modal -->
                        <div class="modal fade" id="editCardModal<?= $card['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editCardModalLabel<?= $card['id']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= site_url('pegawai/beranda/updateCard/' . $card['id']); ?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <div class="form-group">
    ...
    <div class="section-wrapper calendar-section">
        ...
        <div class="form-wrapper">
            <?= $this->include('pegawai/beranda/create_calender'); ?>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    ...
                    <?php foreach ($calenders as $calender): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('pegawai/beranda/deleteKalender/' . $calender['id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this event?');">Delete</a>
                            </td>
                        </tr>
                        <!-- Edit Calendar Modal -->
                        <div class="modal fade" id="editCalendarModal<?= $calender['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editCalendarModalLabel<?= $calender['id']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= site_url('pegawai/beranda/updateCalendar/' . $calender['id']); ?>" method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="title">Title</label>
