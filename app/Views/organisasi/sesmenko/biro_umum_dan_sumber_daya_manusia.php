...
<div class="container-fluid p-0" style="margin-top: 20px;">
    ...
    <div class="col-md-9 p-4">
        <div class="card mx-auto" style="width: 15rem;">
            <div class="card-body">
                <p class="card-text">Kepala Biro Umum dan Sumber Daya Manusia</p>
            </div>
            <img src="<?= base_url('images/EniRukawiani.png'); ?>" class="card-img-top" alt="..." style="width: 230px; height: 230px; object-fit: cover;">
            <div class="card-body">
                <p class="card-text">Eni Rukawiani</p>
            </div>
        </div>
        <br>
