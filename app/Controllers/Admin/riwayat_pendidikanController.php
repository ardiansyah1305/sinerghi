    ...
    public function index()
{
	...
	try {
        ...
        return redirect()->to('/admin/riwayat_pendidikan');
    }
    ...
    public function update($id)
{
    ...
    if ($tahun_masuk === '') {
        return redirect()->back()->withInput()->with('error_rp', 'Tahun Masuk tidak boleh kosong.');
    }
    ...
    if ($tahun_lulus === '') {
        return redirect()->back()->withInput()->with('error_rp', 'Tahun Lulus tidak boleh kosong.');
    }
    ...
    if ($riwayat_pendidikanModel->update($id, $data)) {
        return redirect()->to('/admin/riwayat_pendidikan')->with('success_rp', 'Data berhasil diperbarui.');
    } else {
    ...
    if ($file->isValid() && !$file->hasMoved()) {
        ...
        $header = array_shift($csvData);
            ...
            if ($header !== $expectedColumns) {
                return redirect()->to('/admin/riwayat_pendidikan')->with('error', 'Gagal mengunggah file. Kolom tidak sesuai.');
            }
            ...
            return redirect()->to('/admin/riwayat_pendidikan')->with('success', 'Data berhasil ditambahkan.');
        } else {
            return redirect()->to('/admin/riwayat_pendidikan')->with('error', 'Gagal mengunggah file.');
        }
    }
