...
class BerandaController extends Controller
{
    public function index()
    {
        ...
        return view('pegawai/beranda/index', $data);
    }
    ...
    public function storeSlider()
    {
        ...
        return redirect()->to('/pegawai/beranda');
    }
    ...
    return view('pegawai/beranda/edit_slider', $data);
    }
    ...
    return view('pegawai/beranda/edit_popup', $data);
    }
    ...
    return view('pegawai/beranda/edit_card', $data);
    }
